...
<div class="w-svw h-svh flex justify-center items-center bg-gray-200">
    <div class="w-2/6 h-5/6 bg-white rounded-xl flex flex-col items-center justify-start">
        ...
        <form action="" method="get" class="w-5/6 flex flex-col items-end justify-start mt-5">
            ...
            <input type="password" name="repeatPassword" id="repeatPassword" class="w-full h-10 bg-gray-100 rounded mt-3">
